...
function VendorDashboard() {
  ...
  return (
    <>
      <div className="fixed bg-gray-950 w-full top-0 left-0 h-12 text-gray-400 border-b border-gray-600 z-10 flex items-center px-4">
        <button
...
//       <div
//         className={`bg-gray-950 h-screen md:w-1/5 sm:w-2/5 fixed top-12 left-0 md:${
//           sideBarOpen ? "translate-x-0" : "-translate-x-full"
//         } transition-all duration-300 ease-in-out z-10`}
//       >
