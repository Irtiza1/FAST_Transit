// ye api call karni router.get('/Student/dropdown/:operations/:user/:id?', /*authorizeRole('Student'),*/  studentDropDownView)
...
const UserRoutesPage = () => {
  ...
  // console.log(routes)
  useEffect(() => {
    setUrl('http://localhost:8000/user/Student/dropdown/View/Route');
    console.log(data)
  }, []);
  if(loading){
      ...
      <div className="p-6 bg-gray-900 min-h-screen text-gray-100 border border-gray-600 rounded">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {routeData?.routeData
            ...
            .map((route) => (
              <Link to={`/user/route/${route.RouteID}`}
                key={route.id}
