...
//   const searchResultsRef = useRef(null); // Reference for the search results container
...
//       <h3 className="text-2xl font-semibold mb-4 text-gray-100">Create a Route</h3>
...
//           className="bg-blue-500 text-white px-4 py-1 rounded-lg w-full"
//         >
//           Search
//         </button>
...
//             className="absolute top-full mt-2 bg-gray-100 border rounded-lg max-h-40 overflow-y-auto w-full z-20"
//           >
//             {searchResults.map((result, index) => (
//               <li
//                 key={index}
//                 onClick={() => selectSearchResult(result)}
//                 className="p-2 cursor-pointer hover:bg-blue-200 text-sm"
//               >
//                 {result.display_name}
//               </li>
//             ))}
          ...
          <div className="relative mb-4 w-full flex flex-col items-center">
            <div className="flex w-full">
              <input
                ...
                onChange={(e) => setSearchInput(e.target.value)}
                placeholder="Search for location"
                className="text-gray-300 bg-gray-800 border border-gray-500 border-r-0  rounded-l p-2 w-full focus:ring-2        focus:ring-gray-500 focus:border-gray-500 transition duration-200"
              />
              <button
                onClick={searchLocation}
